...
/* Universal time/date string string getter functions */ 
...
class TimeLib2
{
    ...
    public: 
      ...
      time_t  getEpochSecond();  // return the current time as seconds since Jan 1 1970 (aligned to Java)
      void    setOffset(long adjustment); // adjust the EpochSecond + or -
